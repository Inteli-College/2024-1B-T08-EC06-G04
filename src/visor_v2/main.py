...
class RobotController(Node):
    def __init__(self):
        ...
        # Cria um subscriber para receber dados do LIDAR
    ...
    def lidar_callback(self, msg):
        ...
        # Atualiza as flags de frente e traseira livres
        ...
        # Para o robô se a frente ou a traseira não estiverem livres
    ...
    # Aumenta a velocidade linear se a frente estiver livre
    ...
    # Diminui a velocidade linear se a traseira estiver livre
...
@st.cache_resource
def init_ros_nodes():
    rclpy.init()  # Inicializa o sistema ROS
...
def ui_update():
    ...
    while True:
        try:
            # Obtém a imagem e a latência da fila e atualiza o estado da sessão
...
# Painel de controle para os controles do robô em um layout de joystick
